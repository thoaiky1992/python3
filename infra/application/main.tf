...
# output "data" {
#   value = data.terraform_remote_state.common.outputs.service_discovery
# }
...
#   security_groups                     = data.terraform_remote_state.common.outputs.security_groups
#   db_service_discovery_service        = data.terraform_remote_state.common.outputs.service_discovery.db_service_discovery_service
#   pgbouncer_service_discovery_service = data.terraform_remote_state.common.outputs.service_discovery.pgbouncer_service_discovery_service
